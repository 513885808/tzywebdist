...
<head>
	...
	<title>高考志愿</title>
	<link href="/static/web/css/vendors.033c336c.css" rel="stylesheet"><link href="/static/web/css/bookStep1.0e17472c.css" rel="stylesheet"></head>
<body>
...
<label for="subject_1" class="label_check inline">
						...
						<div class="footerCnt">
							...
							<div class="row btnRow">
								<a class="btn btn-primary btn-form mr30" href="/box/plan/result?planId=29665" target="_blank">
	...
	<script type="text/javascript" src="/static/web/js/vendors.3371a074.js"></script><script type="text/javascript" src="/static/web/js/bookStep1.82fc5030.js"></script></body>
</html>