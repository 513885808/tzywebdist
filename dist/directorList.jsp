...
<head>
	...
	<title>淘志愿</title>
<link href="/static/web/css/vendors.033c336c.css" rel="stylesheet"><link href="/static/web/css/directorList.51f543fb.css" rel="stylesheet"></head>
<body>
	<!-- 公共头部 -->
					...
					<div class="column col1 fl">
						<div class="colPad preloading">
							<div class="content contentWrap">
								...
								<ul class="infoList load-more-list contentWrap ullist">
	...
	<script type="text/javascript" src="/static/web/js/vendors.a172723a.js"></script><script type="text/javascript" src="/static/web/js/directorList.b71989f5.js"></script></body>
</html>